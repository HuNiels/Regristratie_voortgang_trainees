export const constraints = {
    currentPassword: {
        presence: {
            allowEmpty: false,
            message: "^Het huidige wachtwoord is verplicht."
        },
        length: {
            minimum: 4,
            tooShort: "^Huidig wachtwoord heeft minimaal %{count} tekens nodig.",
            maximum: 20,
            tooLong: "^Huidig wachtwoord heeft teveel tekens. Maximum is %{count} tekens."
        }
    },
    newPassword: {
        presence: {
